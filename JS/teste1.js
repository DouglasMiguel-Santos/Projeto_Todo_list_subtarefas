...
//ADICINANDO TAREFA DENTRO DO ARRAY lista
...
function adicionarItem() {
         ...
         <div id="container-subtarefas" class="hidden subtarefas  subtarefas-${posicao} ">
          <ul class="subtarefas  ">
            ...
            >
              ...
              <input type="text" class="input-subtarefas" placeholder="subtarefas">
              <svg
                style="width: 20px"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
  ...
  //salva no localstorage minha lista
...
function criarSubtarefa(posicao) {
  let inputSubtarefas = document.querySelector(".input-subtarefas");
  let subtarefa = document.querySelector(`.subtarefas-${posicao}`);
  console.log(inputSubtarefas.value);

  subtarefa.innerHTML += ` 
  
<li id="subLi" class="subtarefas-${posicao}">
    <input type="checkbox" class="sub-check" />
    <p>  ${inputSubtarefas.value}</p>
  <svg
      style="width: 20px"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      onclick="deletarSubtarefa(${posicao})"
...
//FUNÇAO PARA MOSTRAR AS SUBTAREFAS
...
//FUNCAO PARA ESCONDER AS SUBTAREFAS
...
//     subtarefas: [
//       { titulo: "Revisar arrays", concluida: false },
//       { titulo: "Praticar loops", concluida: true },
//     ],
//   },
// ];
